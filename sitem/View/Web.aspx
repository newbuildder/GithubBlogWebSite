<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Web.aspx.cs" Inherits="sitem.View.Web" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="cerceve">
        ...
        <div class="card">
            <h3>TEMEL JAVASCRIPT DERSLERİ</h3>
            <p>Temel <b>Html</b> komutları ile bir ev yaptık. Sonra <b>Css</b> ile cilalama yaptık. Eve benzer güzel şeyler çıktı. Peki biz bu evin penceresini nasıl açacağız? Kapısını nasıl açacağız? Yani içinde bulunan parçalarına işlevsellik, onlara bir iş yaptırma becerisini işte tamda anlatmak istediğim javascript komutları sayesinde yapacağız. Bir butona tıklandığında ne olur gibi..</p>
            <table>
                <tr>
                    <td>
                        <asp:Button CssClass="button" runat="server" Text="Ders 1" /></td>
